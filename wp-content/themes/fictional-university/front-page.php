    ...
    <div class="full-width-split__inner">
        ...
        <div class="event-summary">
            ...
            <div class="event-summary__content">
                ...
                <p><?= wp_trim_words( get_the_content(), 12 ) ?><a href="<?php the_permalink() ?>" class="nu gray">Learn more</a></p>
            </div>
        </div>
        <?php endwhile; ?>

        <p class="t-center no-margin"><a href="<?= get_post_type_archive_link(get_post_type()); ?>" class="btn btn--blue">View All Events</a></p>
    </div>
    </div>
        ...
        <div class="event-summary">
            ...
            <div class="event-summary__content">
                ...
                <p>
                    ...
                    else echo wp_trim_words( get_the_content(), 12 );
                    ?>
